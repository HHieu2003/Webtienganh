...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 15, 2024 lúc 10:13 PM
...
INSERT INTO `baitest` (`id_baitest`, `id_khoahoc`, `ten_baitest`, `thoi_gian`, `ngay_tao`) VALUES
(1, 36, 'English Grammar Basics Test', 30, '2024-12-15 21:43:36'),
(2, 37, 'English Vocabulary Test', 30, '2024-12-15 22:12:02'),
(3, 39, 'English Grammar Test', 45, '2024-12-15 22:14:55'),
(4, 43, 'English Idioms Test', 40, '2024-12-15 22:17:52'),
(6, 32, 'English Tenses Test', 30, '2024-12-15 23:56:23'),
(7, 42, 'English Vocabulary Test - Advanced', 20, '2024-12-15 23:58:08'),
(9, 32, 'English Antonyms Test', 60, '2024-12-16 00:12:11'),
(29, 32, 'Bài tập về mệnh đề quan hệ', 30, '2024-12-15 03:46:01');
...
(46, 29, 'She is the woman ___ won the Nobel Prize last year.'),
(47, 29, 'This is the house ___ we used to live in.'),
(48, 29, 'The book ___ cover is torn belongs to John.'),
(49, 29, 'The girl ___ brother is a doctor studies at my school.'),
(50, 29, ' The man ___ sold me the car was very polite'),
(51, 29, ' Do you know the woman ___ house we visited last week?'),
(52, 29, 'This is the restaurant ___ serves the best pizza in town.'),
(53, 29, 'The car ___ I drive to work broke down yesterday.'),
(54, 29, ' This is the boy ___ sister is a famous actress.'),
(55, 29, 'The city ___ I was born in is located in the north.'),
...
INSERT INTO `dangkykhoahoc` (`id_dangky`, `id_hocvien`, `id_khoahoc`, `ngay_dangky`, `trang_thai`, `id_lop`) VALUES
(32, 27, 32, '2024-12-10', 'da xac nhan', 'E1'),
(33, 1, 44, '2024-12-15', 'da xac nhan', 'E4'),
(34, 1, 36, '2024-12-15', 'da xac nhan', 'E5'),
(36, 1, 35, '2024-12-15', 'bi tu choi', NULL);

--
-- Bẫy `dangkykhoahoc`
--
DELIMITER $$
CREATE TRIGGER `update_soluong_hocvien_after_delete` AFTER DELETE ON `dangkykhoahoc` FOR EACH ROW BEGIN
    UPDATE lop_hoc
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `update_soluong_hocvien_after_insert` AFTER INSERT ON `dangkykhoahoc` FOR EACH ROW BEGIN
    UPDATE lop_hoc
    SET so_luong_hoc_vien = so_luong_hoc_vien + 1
...
--
-- Đang đổ dữ liệu cho bảng `danhgiakhoahoc`
--

INSERT INTO `danhgiakhoahoc` (`id_danhgia`, `id_hocvien`, `id_khoahoc`, `diem_danhgia`, `nhan_xet`) VALUES
(12, 1, 32, 5, 'Giảng viên của  khóa học dạy rất dễ hiểu');
...
(150, 27, 'E1', 43, 'co mat', '2024-12-16', NULL),
(151, 27, 'E1', 44, 'co mat', '2024-12-16', NULL),
(152, 27, 'E1', 45, 'co mat', '2024-12-16', NULL),
(153, 27, 'E1', 46, 'co mat', '2024-12-16', NULL),
(154, 27, 'E1', 47, 'vang', '2024-12-16', NULL),
(155, 27, 'E1', 48, 'vang', '2024-12-16', NULL),
(156, 27, 'E1', 49, 'vang', '2024-12-16', NULL),
(157, 27, 'E1', 50, 'vang', '2024-12-16', NULL),
(158, 27, 'E1', 51, 'vang', '2024-12-16', NULL),
(159, 27, 'E1', 52, 'vang', '2024-12-16', NULL),
(160, 1, 'E4', 30, 'co mat', '2024-12-16', NULL),
(161, 1, 'E4', 31, 'co mat', '2024-12-16', NULL),
(162, 1, 'E4', 32, 'co mat', '2024-12-16', NULL),
(163, 1, 'E4', 33, 'co mat', '2024-12-16', NULL),
(164, 1, 'E4', 34, 'co mat', '2024-12-16', NULL),
(165, 1, 'E4', 35, 'co mat', '2024-12-16', NULL),
(166, 1, 'E4', 36, 'vang', '2024-12-16', NULL),
(167, 1, 'E4', 37, 'vang', '2024-12-16', NULL),
(168, 1, 'E4', 38, 'vang', '2024-12-16', NULL),
(169, 1, 'E4', 39, 'vang', '2024-12-16', NULL),
(170, 1, 'E4', 40, 'vang', '2024-12-16', NULL),
(171, 1, 'E4', 41, 'vang', '2024-12-16', NULL),
(172, 1, 'E4', 42, 'vang', '2024-12-16', NULL),
(173, 1, 'E5', 73, 'co mat', '2024-12-16', NULL),
(174, 1, 'E5', 74, 'vang', '2024-12-16', NULL),
(175, 1, 'E5', 75, 'vang', '2024-12-16', NULL),
(176, 1, 'E5', 76, 'vang', '2024-12-16', NULL),
(177, 1, 'E5', 77, 'vang', '2024-12-16', NULL),
(178, 1, 'E5', 78, 'vang', '2024-12-16', NULL),
(179, 1, 'E5', 79, 'vang', '2024-12-16', NULL),
(180, 1, 'E5', 80, 'vang', '2024-12-16', NULL),
(181, 1, 'E5', 81, 'vang', '2024-12-16', NULL),
(182, 1, 'E5', 82, 'vang', '2024-12-16', NULL);
...
INSERT INTO `hocvien` (`id_hocvien`, `ten_hocvien`, `email`, `so_dien_thoai`, `mat_khau`, `is_admin`) VALUES
(1, 'Trần Hữu Hiếu', 'hieutran170626@gmail.com', '0337123233', '123456', 0),
(26, 'Hieu Huu', 'hieutran170619@gmail.com', '0123456789', '123456', 1),
(27, 'Test 1', 'T12346@gmail.com', '0123456781', '123456', 0),
(29, 'Nguyễn Văn A ', 'A123456@gmail.com', '0332343454', '12346', 0),
(30, 'Thu Phương ', 'Tp123456@gmail.com', '0387254814', '123456', 0),
(31, 'Nguyễn Hải ', 'NugyenHai1@gmail.com', '0866264811', '123456', 0),
(32, 'Nguyễn Ngọc Lâm', 'Lamngoc23@gmail.com', '0382648264', '123456', 0),
(33, 'Hiền', 'hieu1234@gmail.com', '0974928364', '12346', 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `ketquabaitest`
--
...
--
-- Đang đổ dữ liệu cho bảng `ketquabaitest`
--

INSERT INTO `ketquabaitest` (`id_ketqua`, `id_cauhoi`, `id_hocvien`, `id_baitest`, `diem`, `ngay_lam_bai`) VALUES
(14, NULL, 1, 1, 8, '2024-12-16 01:56:34'),
(15, NULL, 1, 9, 25, '2024-12-16 02:00:40');
...
CREATE TABLE `khoahoc` (
  ...
  `thoi_gian` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `lichhoc` (
  ...
  `phong_hoc` varchar(100) DEFAULT NULL,
  `ghi_chu` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(30, 'E4', '2024-12-16', '08:08:00', '10:08:00', 'Zoom1', ''),
(31, 'E4', '2024-12-23', '08:09:00', '10:09:00', 'Zoom1', ''),
(32, 'E4', '2024-12-26', '07:10:00', '09:10:00', 'Zoom1', ''),
(33, 'E4', '2024-01-01', '08:00:00', '10:00:00', 'zoom1', NULL),
(34, 'E4', '2024-01-04', '10:30:00', '12:30:00', 'zoom1', NULL),
(35, 'E4', '2024-01-07', '14:00:00', '16:00:00', 'zoom1', NULL),
(36, 'E4', '2024-01-10', '09:00:00', '11:00:00', 'zoom1', NULL),
(37, 'E4', '2024-01-13', '13:00:00', '15:00:00', 'zoom1', NULL),
(38, 'E4', '2024-01-16', '08:00:00', '10:00:00', 'zoom1', NULL),
(39, 'E4', '2024-01-19', '10:30:00', '12:30:00', 'zoom1', NULL),
(40, 'E4', '2024-01-22', '14:00:00', '16:00:00', 'zoom1', NULL),
(41, 'E4', '2024-01-25', '09:00:00', '11:00:00', 'zoom1', NULL),
(42, 'E4', '2024-01-28', '13:00:00', '15:00:00', 'zoom1', NULL),
(43, 'E1', '2024-01-01', '08:00:00', '10:00:00', 'zoom1', NULL),
(44, 'E1', '2024-01-08', '10:30:00', '12:30:00', 'zoom1', NULL),
(45, 'E1', '2024-01-15', '14:00:00', '16:00:00', 'zoom1', NULL),
(46, 'E1', '2024-01-22', '09:00:00', '11:00:00', 'zoom1', NULL),
(47, 'E1', '2024-01-29', '13:00:00', '15:00:00', 'zoom1', NULL),
(48, 'E1', '2024-02-05', '08:00:00', '10:00:00', 'zoom1', NULL),
(49, 'E1', '2024-02-12', '10:30:00', '12:30:00', 'zoom1', NULL),
(50, 'E1', '2024-02-19', '14:00:00', '16:00:00', 'zoom1', NULL),
(51, 'E1', '2024-02-26', '09:00:00', '11:00:00', 'zoom1', NULL),
(52, 'E1', '2024-03-04', '13:00:00', '15:00:00', 'zoom1', NULL),
(53, 'E2', '2024-01-01', '08:00:00', '10:00:00', 'zoom2', NULL),
(54, 'E2', '2024-01-08', '10:30:00', '12:30:00', 'zoom2', NULL),
(55, 'E2', '2024-01-15', '14:00:00', '16:00:00', 'zoom2', NULL),
(56, 'E2', '2024-01-22', '09:00:00', '11:00:00', 'zoom2', NULL),
(57, 'E2', '2024-01-29', '13:00:00', '15:00:00', 'zoom2', NULL),
(58, 'E2', '2024-02-05', '08:00:00', '10:00:00', 'zoom2', NULL),
(59, 'E2', '2024-02-12', '10:30:00', '12:30:00', 'zoom2', NULL),
(60, 'E2', '2024-02-19', '14:00:00', '16:00:00', 'zoom2', NULL),
(61, 'E2', '2024-02-26', '09:00:00', '11:00:00', 'zoom2', NULL),
(62, 'E2', '2024-03-04', '13:00:00', '15:00:00', 'zoom2', NULL),
(63, 'E2', '2024-01-01', '08:00:00', '10:00:00', 'zoom2', NULL),
(64, 'E2', '2024-01-08', '10:30:00', '12:30:00', 'zoom2', NULL),
(65, 'E2', '2024-01-15', '14:00:00', '16:00:00', 'zoom2', NULL),
(66, 'E2', '2024-01-22', '09:00:00', '11:00:00', 'zoom2', NULL),
(67, 'E2', '2024-01-29', '13:00:00', '15:00:00', 'zoom2', NULL),
(68, 'E2', '2024-02-05', '08:00:00', '10:00:00', 'zoom2', NULL),
(69, 'E2', '2024-02-12', '10:30:00', '12:30:00', 'zoom2', NULL),
(70, 'E2', '2024-02-19', '14:00:00', '16:00:00', 'zoom2', NULL),
(71, 'E2', '2024-02-26', '09:00:00', '11:00:00', 'zoom2', NULL),
(72, 'E2', '2024-03-04', '13:00:00', '15:00:00', 'zoom2', NULL),
(73, 'E5', '2024-01-01', '08:00:00', '10:00:00', 'Zoom 3', NULL),
(74, 'E5', '2024-01-08', '10:30:00', '12:30:00', 'Zoom 3', NULL),
(75, 'E5', '2024-01-15', '14:00:00', '16:00:00', 'Zoom 3', NULL),
(76, 'E5', '2024-01-22', '09:00:00', '11:00:00', 'Zoom 3', NULL),
(77, 'E5', '2024-01-29', '13:00:00', '15:00:00', 'Zoom 3', NULL),
(78, 'E5', '2024-02-05', '08:00:00', '10:00:00', 'Zoom 3', NULL),
(79, 'E5', '2024-02-12', '10:30:00', '12:30:00', 'Zoom 3', NULL),
(80, 'E5', '2024-02-19', '14:00:00', '16:00:00', 'Zoom 3', NULL),
(81, 'E5', '2024-02-26', '09:00:00', '11:00:00', 'Zoom 3', NULL),
(82, 'E5', '2024-03-04', '13:00:00', '15:00:00', 'Zoom 3', NULL);
...
CREATE TRIGGER `after_insert_lichhoc` AFTER INSERT ON `lichhoc` FOR EACH ROW BEGIN
    ...
    -- Lấy id_khoahoc và ten_lop từ bảng lop_hoc
    SELECT id_khoahoc, ten_lop INTO khoahoc_id, tenlop
    FROM lop_hoc
    WHERE id_lop = NEW.id_lop;

    -- Kiểm tra nếu không tìm thấy id_khoahoc hoặc ten_lop
    IF khoahoc_id IS NULL OR tenlop IS NULL THEN
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'Lỗi: Không tìm thấy lớp học hoặc khóa học tương ứng.';
    END IF;
...
(38, 1, 32, '2024-12-07', 5000000.00, 'Momo', 'Đã chuyển'),
(40, 27, 32, '2024-12-10', 5000000.00, 'Momo', 'Đã chuyển'),
(43, 1, 44, '2024-12-15', 4000000.00, 'Momo', 'Đã chuyển'),
(45, 1, 36, '2024-12-15', 3000000.00, 'Momo', 'Đã chuyển'),
(46, 1, 35, '2024-12-15', 3500000.00, 'Momo', 'Đã chuyển'),
(47, 1, 35, '2024-12-15', 3500000.00, 'Momo', 'Đã chuyển');
...
INSERT INTO `lop_hoc` (`id_lop`, `id_khoahoc`, `ten_lop`, `giang_vien`, `so_luong_hoc_vien`, `trang_thai`) VALUES
('E1', 32, 'English E1', 'Nguyễn Vân Anh', 0, 'dang hoc'),
('E2', 37, 'English E2', ' Trần Huy Hoàng', 0, 'dang hoc'),
('E3', 43, 'English E3', 'Nguyễn Trần Khánh Vy', 0, 'dang hoc'),
('E4', 44, 'English E4', 'Nguyễn Thu Huyền', 0, 'dang hoc'),
('E5', 36, 'English E5', 'Thùy Dung', 0, 'dang hoc');
...
INSERT INTO `thongbao` (`id_thongbao`, `id_hocvien`, `id_khoahoc`, `noi_dung`, `ngay_tao`, `tu_dong`, `tieu_de`, `trang_thai`) VALUES
(54, 1, NULL, '<p>Giảm gi&aacute; lớp học mất gốc 10% hết th&aacute;ng 12 .</p>\r\n', '2024-12-15', NULL, 'Giảm giá lớp học mất gốc ', 'đã đọc'),
(55, 26, NULL, '<p>Giảm gi&aacute; lớp học mất gốc 10% hết th&aacute;ng 12 .</p>\r\n', '2024-12-15', NULL, 'Giảm giá lớp học mất gốc ', 'chưa đọc'),
(56, 27, NULL, '<p>Giảm gi&aacute; lớp học mất gốc 10% hết th&aacute;ng 12 .</p>\r\n', '2024-12-15', NULL, 'Giảm giá lớp học mất gốc ', 'chưa đọc'),
(57, 29, NULL, '<p>Giảm gi&aacute; lớp học mất gốc 10% hết th&aacute;ng 12 .</p>\r\n', '2024-12-15', NULL, 'Giảm giá lớp học mất gốc ', 'chưa đọc'),
(58, 30, NULL, '<p>Giảm gi&aacute; lớp học mất gốc 10% hết th&aacute;ng 12 .</p>\r\n', '2024-12-15', NULL, 'Giảm giá lớp học mất gốc ', 'chưa đọc'),
(59, 31, NULL, '<p>Giảm gi&aacute; lớp học mất gốc 10% hết th&aacute;ng 12 .</p>\r\n', '2024-12-15', NULL, 'Giảm giá lớp học mất gốc ', 'chưa đọc'),
(60, 32, NULL, '<p>Giảm gi&aacute; lớp học mất gốc 10% hết th&aacute;ng 12 .</p>\r\n', '2024-12-15', NULL, 'Giảm giá lớp học mất gốc ', 'chưa đọc'),
(61, 33, NULL, '<p>Giảm gi&aacute; lớp học mất gốc 10% hết th&aacute;ng 12 .</p>\r\n', '2024-12-15', NULL, 'Giảm giá lớp học mất gốc ', 'chưa đọc'),
(62, 1, 44, 'Lớp học \"English E4\" của khóa học \"Khóa học tiếng Anh cho người mới bắt đầu\" có lịch học mới vào ngày: 16/12/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'đã đọc'),
(63, 1, 44, 'Lớp học \"English E4\" của khóa học \"Khóa học tiếng Anh cho người mới bắt đầu\" có lịch học mới vào ngày: 23/12/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'đã đọc'),
(64, 1, 44, 'Lớp học \"English E4\" của khóa học \"Khóa học tiếng Anh cho người mới bắt đầu\" có lịch học mới vào ngày: 26/12/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'đã đọc'),
(65, 1, 44, 'Lớp học \"English E4\" của khóa học \"Khóa học tiếng Anh cho người mới bắt đầu\" có lịch học mới vào ngày: 01/01/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'đã đọc'),
(66, 1, 44, 'Lớp học \"English E4\" của khóa học \"Khóa học tiếng Anh cho người mới bắt đầu\" có lịch học mới vào ngày: 04/01/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'đã đọc'),
(67, 1, 44, 'Lớp học \"English E4\" của khóa học \"Khóa học tiếng Anh cho người mới bắt đầu\" có lịch học mới vào ngày: 07/01/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'đã đọc'),
(68, 1, 44, 'Lớp học \"English E4\" của khóa học \"Khóa học tiếng Anh cho người mới bắt đầu\" có lịch học mới vào ngày: 10/01/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'đã đọc'),
(69, 1, 44, 'Lớp học \"English E4\" của khóa học \"Khóa học tiếng Anh cho người mới bắt đầu\" có lịch học mới vào ngày: 13/01/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'đã đọc'),
(70, 1, 44, 'Lớp học \"English E4\" của khóa học \"Khóa học tiếng Anh cho người mới bắt đầu\" có lịch học mới vào ngày: 16/01/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'đã đọc'),
(71, 1, 44, 'Lớp học \"English E4\" của khóa học \"Khóa học tiếng Anh cho người mới bắt đầu\" có lịch học mới vào ngày: 19/01/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'đã đọc'),
(72, 1, 44, 'Lớp học \"English E4\" của khóa học \"Khóa học tiếng Anh cho người mới bắt đầu\" có lịch học mới vào ngày: 22/01/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'đã đọc'),
(73, 1, 44, 'Lớp học \"English E4\" của khóa học \"Khóa học tiếng Anh cho người mới bắt đầu\" có lịch học mới vào ngày: 25/01/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'đã đọc'),
(74, 1, 44, 'Lớp học \"English E4\" của khóa học \"Khóa học tiếng Anh cho người mới bắt đầu\" có lịch học mới vào ngày: 28/01/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'đã đọc'),
(75, 27, 32, 'Lớp học \"English E1\" của khóa học \"Khóa học tiếng Anh cho người mất gốc\" có lịch học mới vào ngày: 01/01/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'chưa đọc'),
(76, 27, 32, 'Lớp học \"English E1\" của khóa học \"Khóa học tiếng Anh cho người mất gốc\" có lịch học mới vào ngày: 08/01/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'chưa đọc'),
(77, 27, 32, 'Lớp học \"English E1\" của khóa học \"Khóa học tiếng Anh cho người mất gốc\" có lịch học mới vào ngày: 15/01/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'chưa đọc'),
(78, 27, 32, 'Lớp học \"English E1\" của khóa học \"Khóa học tiếng Anh cho người mất gốc\" có lịch học mới vào ngày: 22/01/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'chưa đọc'),
(79, 27, 32, 'Lớp học \"English E1\" của khóa học \"Khóa học tiếng Anh cho người mất gốc\" có lịch học mới vào ngày: 29/01/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'chưa đọc'),
(80, 27, 32, 'Lớp học \"English E1\" của khóa học \"Khóa học tiếng Anh cho người mất gốc\" có lịch học mới vào ngày: 05/02/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'chưa đọc'),
(81, 27, 32, 'Lớp học \"English E1\" của khóa học \"Khóa học tiếng Anh cho người mất gốc\" có lịch học mới vào ngày: 12/02/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'chưa đọc'),
(82, 27, 32, 'Lớp học \"English E1\" của khóa học \"Khóa học tiếng Anh cho người mất gốc\" có lịch học mới vào ngày: 19/02/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'chưa đọc'),
(83, 27, 32, 'Lớp học \"English E1\" của khóa học \"Khóa học tiếng Anh cho người mất gốc\" có lịch học mới vào ngày: 26/02/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'chưa đọc'),
(84, 27, 32, 'Lớp học \"English E1\" của khóa học \"Khóa học tiếng Anh cho người mất gốc\" có lịch học mới vào ngày: 04/03/2024', '2024-12-16', 1, 'Thông báo lịch học mới', 'chưa đọc');
...
INSERT INTO `tien_do_hoc_tap` (`id_tien_do`, `id_hocvien`, `id_khoahoc`, `tien_do`, `so_buoi_da_tham_gia`, `tong_so_buoi`, `ngay_cap_nhat`) VALUES
(4, 27, 32, 40.00, 4, 10, '2024-12-15 19:18:36'),
(5, 1, 44, 46.15, 6, 13, '2024-12-15 19:22:47'),
(6, 1, 36, 10.00, 1, 10, '2024-12-15 19:23:29');
...
(2, 'Trần Hiếu', '12345678', 'hieutran170626@gmail.com', 'Sáng', 'Đã tư vấn'),
(3, 'Huu Hieu', '12345678', 'hieutran17066@gmail.com', 'Sáng', 'Chưa liên hệ');
...
ALTER TABLE `cauhoi`
  ...
  ADD KEY `cauhoi_ibfk_1` (`id_baitest`);
...
ALTER TABLE `dangkykhoahoc`
  ...
  ADD KEY `id_khoahoc` (`id_khoahoc`),
  ADD KEY `dangkykhoahoc_ibfk_1` (`id_lop`);
...
--
ALTER TABLE `baitest`
  MODIFY `id_baitest` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT cho bảng `cauhoi`
--
ALTER TABLE `cauhoi`
  MODIFY `id_cauhoi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=445;
...
--
-- AUTO_INCREMENT cho bảng `danhgiakhoahoc`
--
ALTER TABLE `danhgiakhoahoc`
  MODIFY `id_danhgia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT cho bảng `dapan`
--
ALTER TABLE `dapan`
  MODIFY `id_dapan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1180;

--
-- AUTO_INCREMENT cho bảng `diem_danh`
--
ALTER TABLE `diem_danh`
  MODIFY `id_diemdanh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=183;

--
-- AUTO_INCREMENT cho bảng `hocvien`
--
ALTER TABLE `hocvien`
  MODIFY `id_hocvien` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT cho bảng `ketquabaitest`
--
ALTER TABLE `ketquabaitest`
  MODIFY `id_ketqua` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT cho bảng `khoahoc`
--
ALTER TABLE `khoahoc`
  MODIFY `id_khoahoc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT cho bảng `lichhoc`
--
ALTER TABLE `lichhoc`
  MODIFY `id_lichhoc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;

--
-- AUTO_INCREMENT cho bảng `lichsu_thanhtoan`
--
ALTER TABLE `lichsu_thanhtoan`
  MODIFY `id_thanhtoan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT cho bảng `thongbao`
--
ALTER TABLE `thongbao`
  MODIFY `id_thongbao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;

--
-- AUTO_INCREMENT cho bảng `tien_do_hoc_tap`
--
ALTER TABLE `tien_do_hoc_tap`
  MODIFY `id_tien_do` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT cho bảng `tuvan`
--
ALTER TABLE `tuvan`
  MODIFY `id_tuvan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `baitest`
  ADD CONSTRAINT `baitest_ibfk_1` FOREIGN KEY (`id_khoahoc`) REFERENCES `khoahoc` (`id_khoahoc`);
...
--
-- Các ràng buộc cho bảng `ketquabaitest`
--
ALTER TABLE `ketquabaitest`
  ...
  ADD CONSTRAINT `ketquabaitest_ibfk_3` FOREIGN KEY (`id_baitest`) REFERENCES `baitest` (`id_baitest`) ON DELETE CASCADE;
