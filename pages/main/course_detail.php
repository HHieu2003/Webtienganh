                            ...
                            <div class="reviews-section">
                                ...
                                <?php if ($result_comments->num_rows > 0): ?>
                                    <?php while ($comment = $result_comments->fetch_assoc()): ?>
                                        <div class="review-item"><img src="https://i.pravatar.cc/100?u=<?php echo urlencode($comment['ten_hocvien']); ?>" alt="avatar">
                                            <div class="review-content">
                                                <div class="review-header"><strong><?php echo htmlspecialchars($comment['ten_hocvien']); ?></strong><span class="review-stars"><?php for ($i = 0; $i < 5; $i++): ?><i class="fas fa-star <?php echo ($i < $comment['diem_danhgia']) ? 'filled' : ''; ?>"></i><?php endfor; ?></span></div>
                                ...
                                <div class="submit-review-form">
                                    ...
                                    <form method="POST" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']); ?>#reviews">
                                        <div class="form-group mb-3"><label for="diem_danhgia" class="form-label">Đánh giá của bạn *</label><select name="diem_danhgia" id="diem_danhgia" class="form-select" required>
