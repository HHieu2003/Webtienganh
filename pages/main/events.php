...
.event-category-v4.workshop { background: linear-gradient(135deg, #8E2DE2, #4A00E0); } /* Tím */
.event-category-v4.test { background: linear-gradient(135deg, #F9A825, #FDD835); color: var(--text-dark);} /* Vàng */
.event-category-v4.webinar { background: linear-gradient(135deg, #0072ff, #00c6ff); } /* Xanh dương */
.event-category-v4.club { background: linear-gradient(135deg, #d31027, #ea384d); } /* Đỏ */
.event-category-v4.seminar { background: linear-gradient(135deg, #11998e, #38ef7d); } /* Xanh ngọc */
.event-category-v4.contest { background: linear-gradient(135deg, #FF416C, #FF4B2B); } /* Hồng cam */
.event-category-v4.career { background: linear-gradient(135deg, #02AAB0, #00CDAC); } /* Xanh mint */
.event-category-v4.livestream { background: linear-gradient(135deg, #e52d27, #b31217); } /* Đỏ đậm */
...
@media (max-width: 991px) {
    .event-card-v4, .event-card-v4.reverse {
        flex-direction: column;
    }
    .event-image-v4, .event-card-v4.reverse .event-image-v4 {
        flex-basis: 280px;
        min-height: 280px;
