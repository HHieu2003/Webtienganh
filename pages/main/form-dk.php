...
.consult-section-final .shape-1 { width: 250px; height: 250px; bottom: -50px; left: -50px; animation-duration: 9s; }
.consult-section-final .shape-2 { width: 180px; height: 180px; top: -40px; right: -40px; animation-duration: 7s; }
...
@media (max-width: 991px) {
    .consult-section-final .consult-info-content { text-align: center; margin-bottom: 40px; }
    .consult-section-final .consult-description { margin-left: auto; margin-right: auto; }
    .consult-section-final .offer-item { text-align: left; }
}
</style>