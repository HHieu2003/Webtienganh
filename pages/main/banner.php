<?php
// File: pages/main/banner.php
// Phiên bản được thiết kế lại bởi Đối tác lập trình của bạn - v3.0 (Hoàn chỉnh)
?>
...
<style>
/* ==========================================================
   CSS HOÀN CHỈNH CHO SECTION BANNER - V3.0
   ========================================================== */
.banner-section-v3 {
    position: relative;
    padding: 60px 0;
...
.banner-section-v3 .feature-block-v3 {
    position: relative; /* Đảm bảo nội dung nổi trên nền */
    z-index: 1;
    margin-bottom: 20px;
