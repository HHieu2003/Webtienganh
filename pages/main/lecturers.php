...
<style>
/* ==========================================================
   CSS NÂNG CẤP CHO SECTION GIẢNG VIÊN
   ========================================================== */
...
.lecturer-section-v2 {
    padding: 60px 0;
    background: linear-gradient(135deg, #f0fdf4 0%, #e7f7ec 100%); /* Nền gradient xanh lá nhạt */
    position: relative;
    overflow: hidden;
}
...
.lecturer-card-v2 {
    ...
    height: 100%;
    position: relative; /* Cho hiệu ứng nền */
    overflow: hidden; /* Ẩn phần thừa của hiệu ứng nền */
...
.lecturer-card-v2 > * { /* Đảm bảo nội dung nổi lên trên nền */
    position: relative;
    z-index: 1;
}

.lecturer-card-v2:hover {
    transform: translateY(-12px) scale(1.03); /* Hiệu ứng nổi bật hơn */
...
/* Ảnh đại diện */
.lecturer-avatar-v2 {
    position: relative; /* Cho viền gradient */
    width: 160px;
    height: 160px;
    border-radius: 50%;
    margin: 0 auto 25px;
    padding: 6px; /* Khoảng cách cho viền gradient */
...
.lecturer-avatar-v2 img {
    ...
    border-radius: 50%;
    object-fit: cover;
    border: 4px solid var(--neutral-white); /* Viền trắng bên trong */
...
/* Tên Giảng Viên */
.lecturer-name-v2 {
    font-size: 20px; /* Giảm nhẹ font size */
    font-weight: 700; /* Tăng độ đậm */
    color: var(--brand-color-dark); /* Màu xanh lá đậm */
    margin-bottom: 8px;
    line-height: 1.4;
}
...
.lecturer-description-v2 {
    font-size: 15px;
    color: var(--neutral-gray); /* Màu xám nhạt */
    line-height: 1.7;
    min-height: 85px; /* Tăng chiều cao tối thiểu */
    display: -webkit-box;
...
@media (max-width: 991px) {
    .lecturer-avatar-v2 { width: 140px; height: 140px; }
}
@media (max-width: 767px) {
    .lecturer-avatar-v2 { width: 120px; height: 120px; }
    .lecturer-name-v2 { font-size: 18px; }
    .lecturer-description-v2 { font-size: 14px; min-height: 75px; }
}
...
.lecturer-social-v2 {
    margin-top: 20px; /* Khoảng cách với phần mô tả */
    padding-top: 15px;
    border-top: 1px solid #f0f0f0; /* Đường kẻ mỏng phân cách */
    display: flex;
...
.lecturer-social-v2 a {
    ...
    height: 38px;
    border-radius: 50%;
    background-color: #eef7f0; /* Màu nền xanh lá rất nhạt */
    color: var(--brand-color); /* Màu icon xanh lá */
    font-size: 16px;
...
.lecturer-social-v2 a:hover {
    background-color: var(--brand-color); /* Đổi nền khi hover */
    color: var(--neutral-white); /* Đổi màu icon khi hover */
