...
.point-tenses { background: #dbeafe; color: #1e40af; }
.point-modals { background: #dcfce7; color: #166534; }
.point-conditionals { background: #fef3c7; color: #92400e; }
.point-passive_voice { background: #fce7f3; color: #9f1239; }
.point-reported_speech { background: #f3e8ff; color: #6b21a8; }
.point-relative_clauses { background: #ffedd5; color: #9a3412; }
.point-articles { background: #e0f2fe; color: #075985; }
.point-prepositions { background: #fce7f3; color: #831843; }
.point-comparatives_superlatives { background: #fef9c3; color: #854d0e; }
.point-gerunds_infinitives { background: #f0fdf4; color: #14532d; }
.point-general { background: #f1f5f9; color: #475569; }
