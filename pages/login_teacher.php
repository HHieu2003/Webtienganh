...
// Nếu giảng viên đã đăng nhập, chuyển hướng vào trang admin
...
<head>
    ...
    <title>Đăng nhập Giảng viên - Tiếng Anh Fighter!</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <style>
        :root {
            --brand-color: #007bff;
            /* Thay đổi màu xanh dương để phân biệt */
        ...
        * {
        ...
        body {
            ...
            background: linear-gradient(-45deg, #e0f7fa, #d1e2f8, #e0f7fa, #ffffff);
...
<body>
    <div class="form-container">
        ...
        <form method="post" action="login_teacher.php">
            ...
            <button type="submit" name="login_teacher" class="btn-submit">Đăng nhập</button>
        </form>


        <div class="form-footer">
            <p><a href="login.php">Quay lại đăng nhập cho học viên</a></p>
        </div>
    </div>
</body>
