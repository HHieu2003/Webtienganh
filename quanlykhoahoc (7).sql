...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2025 at 02:49 PM
...
(35, NULL, 1, 41, 0.00, '2025-10-17 15:11:52'),
(36, NULL, 1, 41, 0.00, '2025-10-20 17:13:05'),
(37, NULL, 1, 41, 0.00, '2025-10-20 17:14:18');
...
--
ALTER TABLE `ketquabaitest`
  MODIFY `id_ketqua` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `audio_files`
  ADD CONSTRAINT `audio_files_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
